"""
Django settings for sec_prog project.
...
SECRET_KEY = 'glgr55q=a9v3e@p=y*3vv*=2=te&=t%q(t2+-03=z&$_j!!#00'
...
ROOT_URLCONF = 'sec_prog.urls'

WSGI_APPLICATION = 'sec_prog.wsgi.application'
